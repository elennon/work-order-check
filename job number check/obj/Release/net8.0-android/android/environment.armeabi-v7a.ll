...
@dso_cache = dso_local local_unnamed_addr global [826 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 284664539, ; hash 0x10f7a2db, from name: job number check.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1592867496, ; hash 0x5ef13aa8, from name: job number check
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-job number check.dll.so
		ptr null; void* handle (0x0)
	}, ; 286
	...
	%struct.DSOCacheEntry {
		i64 1750536358, ; hash 0x685710a6, from name: aot-job number check
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-job number check.dll.so
		ptr null; void* handle (0x0)
	}, ; 314
	...
	%struct.DSOCacheEntry {
		i64 2222641322, ; hash 0x847ad0aa, from name: aot-job number check.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-job number check.dll.so
		ptr null; void* handle (0x0)
	}, ; 421
	...
	%struct.DSOCacheEntry {
		i64 2337979977, ; hash 0x8b5abe49, from name: libaot-job number check
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-job number check.dll.so
		ptr null; void* handle (0x0)
	}, ; 448
	...
	%struct.DSOCacheEntry {
		i64 3526400075, ; hash 0xd230984b, from name: libaot-job number check.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-job number check.dll.so
		ptr null; void* handle (0x0)
	}, ; 678
